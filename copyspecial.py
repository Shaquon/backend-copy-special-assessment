...
def get_special_paths(dir):
    """ Given dir name returns the appended results of the search for special files"""
    result = []
...
def copy_to(path, files):
    """ copies absolute path of special files to a directory (only if --todir is an arg)"""
    cwd = os.getcwd()
